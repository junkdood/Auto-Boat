...
"""autogenerated by genpy from hesai_lidar/PandarScan.msg. Do not edit."""
import codecs
import sys
...
import genpy
import hesai_lidar.msg
import std_msgs.msg

class PandarScan(genpy.Message):
  _md5sum = "96facf9d6e028e0cacbe7058fbabc851"
  _type = "hesai_lidar/PandarScan"
...
uint32 size"""
  ...
  _slot_types = ['std_msgs/Header','hesai_lidar/PandarPacket[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PandarScan, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = hesai_lidar.msg.PandarPacket()
        _v2 = val1.stamp
        _x = _v2
        start = end
        end += 8
